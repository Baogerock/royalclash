...
class ComboDetector:
  ...
  def predict(self, source, show=False, save=True, video_interval=1):
    ...
    open_window = False
    path_save_result = path_root / "logs/detection" / time.strftime("%Y.%m.%d_%H-%M-%S")
    if save:
...
if __name__ == '__main__':
  ...
  combo.predict("C:/0ShitMountain/royalclash/video/1.mp4", show=True, save=True, video_interval=3)
